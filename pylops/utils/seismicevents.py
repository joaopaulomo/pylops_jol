...
def _filterdata(
    d: NDArray, nt: int, wav: npt.ArrayLike, wcenter: int
...
def makeaxis(par: dict) -> tuple[NDArray, NDArray, NDArray, NDArray]:
...
def parabolic2d(
    ...
    t: NDArray,
    t0: float | tuple[float],
    px: float | tuple[float],
    pxx: float | tuple[float],
    amp: float | tuple[float],
    wav: NDArray,
) -> tuple[NDArray, NDArray]:
...
def parabolic3d(
    ...
    t0: float | tuple[float],
    px: float | tuple[float],
    py: float | tuple[float],
    pxx: float | tuple[float],
    pyy: float | tuple[float],
    amp: float | tuple[float],
    wav: NDArray,
) -> tuple[NDArray, NDArray]:
...
def hyperbolic3d(
    ...
    t: NDArray,
    t0: float | tuple[float],
    vrms_x: float | tuple[float],
    vrms_y: float | tuple[float],
    amp: float | tuple[float],
    wav: NDArray,
):
